      ...
      >
        ...
        <View className="p-3">
          ...
          <View className="flex-row justify-between items-center mt-1">
            <Text className="text-xs text-gray-600">{item.articleType}</Text>
          ...
          <View className="flex-row items-center mt-2">
            <View
              ...
              style={{ backgroundColor: item.baseColour.toLowerCase() }}
            />
            <Text className="text-xs text-gray-500">{item.baseColour}</Text>
          </View>
        </View>
      </TouchableOpacity>
    </Animated.View>
